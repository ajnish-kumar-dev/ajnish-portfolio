...
const navItems = [
  ...
  { to: '/dashboard/products', label: 'Browse Products', icon: ShoppingBag },
  { to: '/dashboard/orders', label: 'My Orders', icon: FileText },
...
export function DashboardLayout() {
  ...
  const { count: cartCount } = getCartTotal();
        ...
        {(sidebarOpen || true) && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 bottom-0 z-50 w-[280px] bg-[#0F172A] border-r border-slate-800 lg:translate-x-0 lg:block"
            >
                      ...
                      {userMenuOpen && (
                        ...
                        >
                          <NavLink
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-700 transition-colors"
                          >
