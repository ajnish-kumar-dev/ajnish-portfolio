...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 via-gray-800 to-black dark:from-gray-950 dark:via-gray-900 dark:to-black text-white relative overflow-hidden">
