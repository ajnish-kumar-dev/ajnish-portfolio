        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            >
              ...
              <a href="https://x.com/rohit02020" className="group p-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-lg hover:scale-110 transition-all duration-300">
